...
// ==========================================
// 6.1 MOVIMENTOS DE TRANSFERÊNCIA DE ESTOQUE (TELA OFICIAL)
// ==========================================
export const MOCK_TRANSFERENCIAS: TransferenciaEstoque[] = [
  {
    id: 'trf-168543',
    identificador: '168543',
    numeroMovimento: '0000689',
    serie: 'TF',
    tipoMovimento: '3.1.03 - Transferencia de Local de Est. (FISICO/FISCAL)',
    status: 'Normal',
    horaEmissao: '14:43:30',
    dataEmissao: '2026-08-19',
    usuarioInclusao: 'JANAINA',
    filialOrigem: '1 - RARUS TECNOLOGIA E SERVICOS',
    origemLocalId: 'est-tec-vinicius',
    origemLocalNome: '006 - Estoque Vinicius - Rarus',
    filialDestino: '1 - RARUS TECNOLOGIA E SERVICOS',
    destinoLocalId: 'est-tec-caio',
    destinoLocalNome: '015 - Estoque Caio Detz - Rarus',
    funcionarioCodigo: '038',
    funcionarioNome: 'Janaína Sousa',
    observacoes: 'Transferência de placas e componentes para reposição emergencial em bancada de laboratório.',
    itens: [
      {
        seq: '001',
        itemCodigo: '004674',
        descricao: 'CHICOTE SERIAL E FONTE BK REV.1.00',
        unidade: 'PC',
        quantidade: 2,
        saldoFisicoOrigem: 4,
        precoUnitario: 0,
      ...
      },
      {
        seq: '002',
        itemCodigo: '003957',
        descricao: 'CELULA DE CARGA ZEMIG MED BANCADA',
        unidade: 'PC',
        quantidade: 1,
        saldoFisicoOrigem: 1,
        precoUnitario: 0,
      ...
      },
      {
        seq: '003',
        itemCodigo: '003958',
        descricao: 'PE DE BORRACHA MEDIDOR PRETO UNI',
        unidade: 'PC',
        quantidade: 10,
        saldoFisicoOrigem: 23,
        precoUnitario: 0,
        valorItem: 0,
        valorDesconto: 0,
        percentualDesconto: 0,
      },
      {
        seq: '004',
        itemCodigo: '004643',
        descricao: 'CABO FLAT 10 VIAS BK',
        unidade: 'UN',
        quantidade: 2,
        saldoFisicoOrigem: 6,
        precoUnitario: 0,
      ...
      },
      {
        seq: '005',
        itemCodigo: '004672',
        descricao: 'BOBINA 450 ESPIRAS - BK',
        unidade: 'PC',
        quantidade: 2,
        saldoFisicoOrigem: 10,
        precoUnitario: 0,
        valorItem: 0,
        valorDesconto: 0,
        percentualDesconto: 0,
      },
      {
        seq: '006',
        itemCodigo: '004673',
        descricao: 'BOBINA 600 ESPIRA VERSAO 2.0 BK',
        unidade: 'UN',
        quantidade: 2,
        saldoFisicoOrigem: 7,
        precoUnitario: 0,
      ...
      },
      {
        seq: '007',
        itemCodigo: '005196',
        descricao: 'PCI PRINCIPAL G610I/G650I VERSAO 2.0',
        unidade: 'UN',
        quantidade: 5,
        saldoFisicoOrigem: 18,
        precoUnitario: 0,
        valorItem: 0,
        valorDesconto: 0,
        percentualDesconto: 0,
      ...
      },
      {
        seq: '009',
        itemCodigo: '004511',
        descricao: 'PCI PRINCIPAL G610I VERSAO 7.0',
        unidade: 'UN',
        quantidade: 2,
        saldoFisicoOrigem: 6,
        precoUnitario: 0,
      ...
      },
      {
        seq: '010',
        itemCodigo: '004476',
        descricao: 'PCI PRINCIPAL G810/G939',
        unidade: 'PC',
        quantidade: 3,
        saldoFisicoOrigem: 5,
        precoUnitario: 0,
      ...
      },
      {
        seq: '011',
        itemCodigo: '004633',
        descricao: 'CONECTOR DC P2 DJK-01 G600/G650/600',
        unidade: 'UN',
        quantidade: 1,
        saldoFisicoOrigem: 2,
        precoUnitario: 0,
  ...
  {
    id: 'trf-168544',
    identificador: '168544',
    numeroMovimento: '0000690',
    serie: 'TF',
    tipoMovimento: '3.1.03 - Transferencia de Local de Est. (FISICO/FISCAL)',
    status: 'Pendente',
    horaEmissao: '09:12:00',
    dataEmissao: '2026-09-01',
    usuarioInclusao: 'CAIO DETZ',
    filialOrigem: '1 - RARUS TECNOLOGIA E SERVICOS',
    origemLocalId: 'est-central',
    origemLocalNome: '001 - Almoxarifado Central - Matriz',
    filialDestino: '1 - RARUS TECNOLOGIA E SERVICOS',
    destinoLocalId: 'est-tec-itamar',
    destinoLocalNome: '002 - Estoque Itamar Soares - Rarus',
    funcionarioCodigo: '058',
    funcionarioNome: 'Caio Detz',
    observacoes: 'Requisição de células e sensores para calibrações de campo em cooperativas da região Sul.',
    itens: [
      {
        seq: '001',
        itemCodigo: 'PEC-GEH-01',
...
export const MOCK_ORDENS_SERVICO: OrdemServico[] = [
  {
    ...
    equipamentos: [
      {
        ...
        modelo: 'G650I',
        numeroSequencial: 1,
        certificadoNumero: '0005303-1/26',
    ...
    pecas: [
      {
        pecaId: 'srv-000303',
        codigo: '000303',
        descricao: 'SERV MED UMID GRAOS PORTATIL LAB',
        quantidade: 1,
        valorUnitario: 974.30,
        valorTotal: 974.30,
        tipoItem: 'Servico',
      ...
      },
      {
        pecaId: 'pec-004514',
        codigo: '004514',
        descricao: 'FONTE ALIMENTAÇÃO 9V 1A - PLUG FIXO',
        quantidade: 1,
        valorUnitario: 147.00,
        valorTotal: 147.00,
        tipoItem: 'Peca',
        estoqueOrigemId: 'est-central',
      },
      {
        pecaId: 'pec-004509',
        codigo: '004509',
        descricao: 'ADESIVO DO PAINEL G650i',
        quantidade: 1,
        valorUnitario: 109.30,
        valorTotal: 109.30,
        tipoItem: 'Peca',
        estoqueOrigemId: 'est-central',
      },
      ...
      },
      {
        pecaId: 'pec-003156',
        codigo: '003156',
        descricao: 'CAIXA MED UMID PORTATIL',
        quantidade: 1,
        valorUnitario: 0.00,
        valorTotal: 0.00,
        tipoItem: 'Peca',
    ...
    descricaoProblema:
      'DEFEITO: MANUTENÇÃO PREVENTIVA VENCIDA, PCI ANTIGA NÃO CALIBRA, ADESIVO DANIFICADO, KNOBS RESSECADOS, BATERIA VOLTAGEM BAIXA, FONTE INADEQUADA. SOLUÇÃO: MANUTENÇÃO PREVENTIVA, TROCA DAS PEÇAS.',
    laudoTecnico:
      'Manutenção corretiva e/ou preventiva, verificação de funcionamento, desmontagem e montagem, limpeza geral, ajustes eletrônicos e mecânicos com padrões de fábrica, atualização de versão (quando aplicável), troca de selo reparado e lacre, calibração com certificado rastreado.',
  ...
  },
  {
    ...
    numero: '0005307',
    clienteId: 'cli-1',
    clienteNome: 'ESPAÇOGRÃOS EMPREENDIMENTOS E PARTICIPAÇÕES S/A',
    tipo: 'Laboratório e Vendas',
    prioridade: 'Alta',
    status: 'Em Serviço',
    equipamentos: [
      {
        ...
        modelo: 'GEHAKA G650i',
        numeroSequencial: 1,
        certificadoNumero: '0005307-1/26',
        statusItem: 'Em Calibração',
        observacoes: 'Medidor Moega Central',
      },
    ],
    pecas: [
      {
    ...
    descricaoProblema: 'Calibração anual periódica e troca de guarnições internas do duto.',
    valorTotalServicos: 580.0,
    valorTotalPecas: 0,
    valorTotalGeral: 580.0,
    faturada: false,
  },
  {
    id: 'os-1045',
